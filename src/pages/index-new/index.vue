          ...
          <view class="center-btn" :style="{ 'background-image': 'url(' + imgCenterBtn + ')' }">
            ...
            <view class="ring" @click="assessScore">
              <view class="cbtn">
                ...
                <view class="p2" v-if="complexScore == -1"> {{ !getToken ? '登录查询' : '查询' }}</view>
                <view class="p2" v-else> {{ complexScore }}万</view>
              </view>
            </view>
          </view>
          <!-- <view class="per">高于90%人群</view> -->
          <view class="btn-box1" v-if="complexScore != -1">
            <view class="box1">
...
export default Vue.extend({
  ...
  data() {
    return {
      ...
      imgCurrentSj: this.$OSS_IMAGES_URL + '/20220617/%E5%BD%93%E5%89%8D%E8%BA%AB%E4%BB%B7logo%402x.png',
      imgUpSj: this.$OSS_IMAGES_URL + '/20220617/%E6%BD%9C%E5%9C%A8%E8%BA%AB%E4%BB%B7%402x.png',
      ...
      imgSh: this.$OSS_IMAGES_URL + '/20220617/%E4%B8%8A%E6%BB%91%402x.png',
      imgCenterBtn: this.$OSS_IMAGES_URL + '/20220617/3.0%E5%9C%86%E8%BA%AB%E4%BB%B7%E8%AF%84%E4%BC%B0%402x.png',
      imgSlidePanel: this.$OSS_IMAGES_URL + '/20220617/indexCc.png',
      ...
      swipers: [
        this.$OSS_IMAGES_URL + '/20220617/%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_20220625101216.jpg',
        this.$OSS_IMAGES_URL + '/20220617/1.jpg',
        this.$OSS_IMAGES_URL + '/20220617/2.jpg',
      ],

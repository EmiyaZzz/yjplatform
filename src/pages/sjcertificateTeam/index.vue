    ...
    <view class="index-wrapper">
      ...
      <view class="body">
        ...
        <view class="fun-bg">
          ...
          <!-- <view class="btn1" @click="downloadImg">下载</view> -->
        </view>
        <view class="fun-bg">
...
<script>
import Vue from 'vue'
import { TeamCertificate, reportOrder, avatorImg, userPicDetail } from '@/api/common.js'
...
export default Vue.extend({
  ...
  onLoad: function (options) {
    ...
    TeamCertificate({ teamId: this.teamId }).then((res) => {
      console.log(res)
      this.imgUrl = res
    }).catch((err) => {
        ...
        success: function (res) {
          if (res.confirm) {
            ...
            reportOrder(
              ...
              TeamCertificate({ teamId: that.teamId }).then((res) => {
                that.imgUrl = res
              }).catch((err) => {

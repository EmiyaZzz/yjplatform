        ...
        <view class="box-panel">
          <view class="data-form-content">
            ...
            <view class="in-box at-row align-center space-between">
              ...
              <view>
                ...
                <view v-if="sexS.label">
                  {{ sexS.label }}
                </view>  <view v-if="!sexS.label">请选择</view>
                </view>
              </view>
            </view>
            <view class="in-box at-row align-center space-between">
            ...
            <view class="in-box at-row align-center space-between">
              ...
              <view class="select-group">
                <rcjy-input style="text-align:right" :disabled="true" placeholder="请选择单位所在省市区" :inval="companyAreaName">
                </rcjy-input>
            ...
            <view class="in-box at-row align-center space-between">
              ...
              <view>
                <view class="select-group" @click="$refs.checkPark.isShow = true">
                  <view v-if="isParkUnit.label">
                    {{ isParkUnit.label }}</view>
            ...
            <view class="in-box at-row align-center space-between" v-if="isHighTechArea.value == 0">
              ...
              <view>
                <view class="select-group" @click="$refs.highTechAreas.isShow = true">
                  <view v-if="highTechAreasS.label"> {{ highTechAreasS.label }}</view>
...
export default Vue.extend({
  ...
  methods: {
    async init() {
      ...
      if (this.getToken) {
        await getUserInfoApi().then((data) => {
          ...
          this.companyAreaName = data.companyProvinceName + '-' + data.companyCityName + '-' + data
            .companyAreaName
    ...
    districtsConfirm(data) {
      this.companyAreaName = data.provinceName + '-' + data.city + '-' + data.areaName
